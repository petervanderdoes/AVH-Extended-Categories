...
class AVH_EC_Admin
{
	...
	function metaboxDonations ()
	{
		...
		echo '<a href="https://www.amazon.com/?tag=petervanderdoes-20" target="_blank" title="Amazon Homepage"><img alt="Amazon Button" src="' . $this->core->info['graphics_url'] . '/us_banner_logow_120x60.gif" /></a>';
		echo '</div>';

		echo '<div class="p">';
		echo __('You can send me something from my ', 'avh-ec') . '<a href="http://www.amazon.com/registry/wishlist/1U3DTWZ72PI7W?tag=petervanderdoes-20">' . __('Amazon Wish List', 'avh-ec') . '</a>';
		echo '</div>';
